...
class Encoder(nn.Module):
    ...
    def __init__(self, input_shape, latent_dim):
        ...
        self.convs = nn.Sequential(
            nn.Conv2d(3, 32, kernel_size=3, stride=1, padding=1), # (batch_size, 32, H, W)
            nn.ReLU(),
            nn.Conv2d(32, 64, kernel_size=3, stride=2, padding=1), # (batch_size, 64, H/2, W/2)
            nn.ReLU(),
        ...
        dims = 256*(input_shape[1]//8)*(input_shape[2]//8)
        self.fc = nn.Linear(dims, self.latent_dim)
        ##################################################################
        #                          END OF YOUR CODE                      #
        ##################################################################
...
class VAEEncoder(Encoder):
    def __init__(self, input_shape, latent_dim):
        ...
        ##################################################################
        dims = 256*(input_shape[1]//8)*(input_shape[2]//8)
        self.fc = nn.Linear(dims, 2*self.latent_dim)
        ##################################################################
        #                          END OF YOUR CODE                      #
        ##################################################################
